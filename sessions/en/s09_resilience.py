...
class ContextGuard:
    ...
    def truncate_tool_results(self, messages: list[dict]) -> list[dict]:
        """Truncate oversized tool result messages to reduce context usage."""
...
class ResilienceRunner:
    ...
    def _run_attempt(
        ...
        Runs the while True + finish_reason pattern from s01/s02.
        Returns (message, updated_messages) on stop.
        ...
        while iteration < self.max_iterations:
            ...
            if finish_reason == "stop":
                return message, current_messages
                ...
                # Unexpected finish_reason (e.g. length) -- treat as stop
                return message, current_messages
